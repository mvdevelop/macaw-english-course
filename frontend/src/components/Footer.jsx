import { ShieldCheckIcon, PhoneIcon, MailIcon, MapPinIcon, FacebookIcon, InstagramIcon, YoutubeIcon } from "lucide-react";
    ...
    const footerLinks = [
        ...
        },
        {
            ...
            links: [
                ...
                { label: t("footer.reclameAqui"), href: "https://www.reclameaqui.com.br", target: "_blank" },
        ...
        <footer className="w-full bg-[#0f0f1a] text-white">
            ...
            <div className="border-b border-slate-800">
                <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-center gap-6 px-6 py-4 text-xs text-slate-400">
                    ...
                    <a href="https://www.reclameaqui.com.br" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center gap-2">
                            <img src="/macaw.png" alt="Macaw" className="size-8 object-contain" width={32} height={32} />
                        ...
                        <div className="flex items-center gap-3 mt-6">
                            <a href="#" className="size-9 rounded-lg bg-slate-800 hover:bg-primary transition flex items-center justify-center text-slate-400 hover:text-white">
                    ...
                    {footerLinks.map((group) => (
                        <div key={group.title}>
                            <h3 className="font-semibold text-sm text-white mb-4 uppercase tracking-wider">{group.title}</h3>
