...
export const FaqSection = () => {
    ...
    return (
        <div id="faq" className="relative max-w-2xl mx-auto flex flex-col items-center justify-center px-4 md:px-0 pt-20 pb-32">
            ...
            <SectionTitle text1={t("faq.label")} text2={t("faq.title")} text3="" />
            <div className="mt-8">
